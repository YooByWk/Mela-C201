  ...
  return (
    <div className={className}>
      <Routes>
        ...
        <Route path="/teamspace/:teamspaceIdx" element={<TeamspaceDetail />} />

        <Route path="/teamspace/:teamspaceIdx/team" element={<TeamspaceTeam />} />

        <Route path="/teamspace/:teamspaceIdx/audio" element={<TeamspaceAudio />} />

        <Route path="/teamspace/:teamspaceIdx/file" element={<TeamspaceFile />} />

        <Route path="/teamspace/:teamspaceIdx/management" element={<TeamspaceManage />} />
        ...
        <Route path="/musics" element={<PortfolioAll />} />
